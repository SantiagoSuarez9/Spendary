...
import { cardOptions, serviceOptions } from '@/data/mockData';
...
const ExpenseForm: React.FC = () => {
  ...
  const onSubmit = async (data: ExpenseFormData) => {
    ...
    addExpense({
      ...
      serviceName: selectedCategory === 'services' ? data.serviceName : undefined,
    });

    toast.success('Gasto agregado correctamente', {
      description: `$${data.amount} en ${categories.find(c => c.value === selectedCategory)?.label}`,
    });
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          {selectedCategory === 'cards' && (
            <motion.div
              ...
              className="space-y-2"
            >
              <Label className="text-sm font-medium text-foreground">Tarjeta</Label>
              <Select value={cardName} onValueChange={(v) => setValue('cardName', v)}>
          ...
          {selectedCategory === 'services' && (
            ...
            >
              ...
              <Select value={serviceName} onValueChange={(v) => setValue('serviceName', v)}>
                <SelectTrigger className="h-12">
